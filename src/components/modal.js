...
const Modal = ({isVisible, onClose, children}) => {
    ...
    return(
        <div className='z-50 fixed inset-0 bg-black overflow-y-auto bg-opacity-5 backdrop-blur-sm flex justify-center z-10 items-center transition-opacity duration-700'>
            <div className='w-full md:max-w-[500px] md:w-[50%] mx-auto bg-dark-night text-white p-2 border-2 border-purple shadow-input rounded-lg flex flex-col transition-opacity duration-700'>
                {/* Close Button */}
