                    ...
                    <div className="flex items-center space-x-6 rtl:space-x-reverse">
                        ...
                        { currentUser != null ? (
                            <>
                                ...
                                <svg onClick={signOut} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 text-white cursor-pointer rotate-180 hover:scale-110 hover:text-slate-200">
