    ...
    <Card className="justify-self-end h-auto w-auto my-6 bg-blue-900 border-blue-900 row-span-1 col-start-1 col-end-2"  >
        <div className="py-10 overflow-y-auto ">
            <ul className="space-y-10 font-medium">
                <li>
                    <Link href="/profile" className="flex items-center p-2 text-gray-900 rounded hover:bg-gray-100 dark:hover:bg-gray-700 group ">
                ...
                <li>
                    <Link href="/profile/address" className="flex items-center p-2 text-gray-900 rounded hover:bg-gray-100 dark:hover:bg-gray-700 group ">
                ...
                <li>
                    <Link href="/profile/card" className="flex items-center p-2 text-gray-900 rounded hover:bg-gray-100 dark:hover:bg-gray-700 group ">
                ...
                <li>
                    <Link href="/profile/order" className="flex items-center p-2 text-gray-900 rounded hover:bg-gray-100 dark:hover:bg-gray-700 group ">
                ...
                <li>
                    <Link href="/profile/reviews" className="flex items-center p-2 text-gray-900 rounded hover:bg-gray-100 dark:hover:bg-gray-700 group ">
                ...
                <li>
                    <Link href="#" className="flex items-center p-2 text-gray-900 rounded hover:bg-gray-100 dark:hover:bg-gray-700 group ">
