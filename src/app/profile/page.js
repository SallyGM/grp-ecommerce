...
export default function Home() {
    ...
    return (
        <div className='grid grid-rows-1 grid-cols-4 gap-x-10 row-start-1 row-end-2 col-start-1 col-end-3 bg-blue-800 ' > 
        ...
        <Card className=" justify-self-center h-auto w-full my-6 mr-12 bg-blue-900 border-blue-900 row-start-1 row-end-1 col-start-2 col-end-5 " >
            ...
            <div className="justify-evenly inline-flex mt-6">
                <label className='text-white'>FIRST NAME:</label>
                <input disabled className="block w-96 rounded-md border-0 py-1.5 px-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                type="first name" id="first name" name="fname"/>
            </div>
            <div className="justify-evenly inline-flex mt-6">
            ...
            <Button
                disabled
                type="submit"
                className="w-40 visible place-self-end mr-48" color='success'>
                SAVE
            </Button>
