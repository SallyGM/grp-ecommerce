  ...
  return (
    ...
    <div className='grid grid-rows-1 grid-cols-1 p-8 flex justify-content-center bg-dark-night'>
        ...
        <div className="flex">
          ...
          <div className="w-1/4">
            <div className="relative mb-2">
              ...
              <div className="w-10 h-10 mx-auto bg-green-500 rounded-full text-lg text-white flex items-center">{/*bg-green-500 */}
                <span className="text-center text-white w-full">
      ...
      <Card className="justify-self-center h-auto w-4/5 my-6 bg-blue-900 border-blue-900">
        ...
        <h1 className="text-4xl font-bold tracking-tight text-gray-900 dark:text-white self-center text-white font-mono">ADDRESS DETAILS</h1>
        <br/>
