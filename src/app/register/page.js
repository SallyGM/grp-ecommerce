...
export default function Home() {
  return (
    ...
    <div className='grid grid-rows-1 grid-cols-1 p-8 display: flex bg-dark-night'>
      {/*Status bar */}
      <div className="flex-wrap content-evenly w-full py-6">
        <div className="flex">
          <div className="w-1/4">
            ...
            <div className="relative mb-2">
              <div className="absolute flex align-center items-center align-middle content-center" style={{ width: 'calc(100% - 2.5rem - 1rem)', top: '50%', transform: 'translate(-50%, -50%)' }}>
                <div className="w-full bg-gray-200 rounded items-center align-middle align-center flex-1">
                  <div className="w-0  py-1 bg-green-300 rounded" style={{ width: '33%' }}></div>{/*bg-green-300 */}
                </div>
              </div>
