      ...
      <div className="flex h-full flex-col justify-center gap-4 p-6 rounded-lg justify-self-center w-auto h-auto my-6 summary-box border-2 border-white shadow-card">
        ...
        <form className="grid grid-cols-1 gap-6 md:grid-cols-2 sm:w-auto md:w-full self-center text-white font-mono" onSubmit={handleSubmit}>
          <div className="col-span-full md:col-span-1">
            ...
            <input className="block w-full bg-transparent rounded-md py-1.5 px-1.5 mt-2 focus:bg-transparent border-2 border-white hover:shadow-input hover:border-purple focus:shadow-input focus:shadow-focus focus:border focus:border-purple focus:outline-none focus:placeholder:text-white"
          ...
          <div className="col-span-full md:col-span-1">
            ...
            <div className="col-span-full md:col-span-1">
              ...
              <div className='inline-flex items-center col-span-2 mt-6 z-30' onClick={()=> setShowAddCardModal(true)}>
                ...
                <a className="ml-5 text-sm font-semibold text-white transition hover:scale-110 hover:text-light-purple">Add Card Details (Optional)</a>
              </div>
        ...
        <div className="self-center sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <form className="space-y-6 text-white font-mono">
            <div>
              ...
              <input className="block w-full bg-transparent placeholder:text-grey-200 rounded-md py-1.5 px-1.5 mt-2 focus:bg-transparent border-2 border-white hover:shadow-input hover:border-purple focus:shadow-input focus:shadow-focus focus:border focus:border-purple focus:outline-none focus:placeholder:text-white"
