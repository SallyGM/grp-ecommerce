    ...
    <div className='flex flex-col md:flex-row lg:flex-row bg-blue-gradient'> 
      <div className="self-center h-screen w-1/2 my-6 my-12 summary-box sm:my-6 sm:mx-6 md:ml-24 md:mr-3 overflow-y-scroll no-scrollbar p-6 rounded-lg shadow" >
        ...
        <div className="flex flex-col">
          ...
          <button onClick={signInWithFacebook} className="text-white w-full bg-blue-600 hover:bg-blue-500 focus:ring-4 focus:outline-none focus:ring-blue-600/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-blue-600/55 me-2 mb-2 md:w-80 justify-center self-center">
          ...
          <button onClick={signInWithGoogle} className="text-white w-full mt-2 bg-red-400 hover:bg-red-300 focus:ring-4 focus:outline-none focus:ring-red-400/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-red-400/55 me-2 mb-2 md:w-80 justify-center self-center">
            <svg className="w-6 h-6 me-2" fill='white' aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      ...
      <div className="self-center h-screen w-1/2 my-6 my-12 summary-box sm:my-6 sm:mx-6 md:mr-24 md:ml-3 overflow-y-scroll no-scrollbar p-6 rounded-lg shadow">
        ...
        <div class="flex flex-col md:flex-row items-center m-3 justify-center self-center p-4 text-sm text-white rounded-lg bg-transparent dark:bg-gray-800 dark:text-gray-300 " role="alert">
