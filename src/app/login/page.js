  ...
  return (
    <div className='grid grid-rows-1 grid-cols-2 display: flex justify-content: center gap-6 row-span-1 row-end-2 bg-blue-800 ' > 
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form className="space-y-6 text-white font-mono" action="#" method="POST onSubmit={handleSubmit}" >
            <div>
              ...
              <input className="block w-full mt-2 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
              type="email" id="email" name="email" required value={email} onChange={handleEmailChange}/>
            ...
            <div>
              ...
              <input className="block w-full mt-2 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
              type="password" id="password" name="password" required value={password} onChange={handlePasswordChange}/>
          ...
          <div className='flex place-content-end'>
            <Button className="justify-self-end w-52 bg-green-400" type="submit">LOGIN</Button>
          </div>

          {/*Divider, to fix with Tailwind */} 
      ...
      <Card className=" justify-self-start h-auto  w-2/3 my-6 bg-blue-900 border-blue-900" >
        <h1 className="text-4xl font-bold text-white font-mono ">REGISTER</h1>
        ...
        <div class="grid-benefit">
          <svg className="text-white" xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-tags" viewBox="0 0 16 16">
          ...
          <svg className="text-white" xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-globe" viewBox="0 0 16 16">
        ...
        <Button type="submit" className=" flex place-content-center w-72 my-28 bg-green-400">
