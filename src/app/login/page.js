...
export default function Home() {
  return (
    <div className='grid grid-rows-1 grid-cols-2 display: flex justify-content: center gap-6 row-span-1 row-end-2' > 
    <Card className="justify-self-end h-auto w-2/3 my-6"  >
