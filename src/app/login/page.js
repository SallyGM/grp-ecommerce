  ...
  return (
    <div className='grid grid-rows-1 grid-cols-2 gap-6 row-span-1 bg-dark-night'> 
      ...
      <Card className=" justify-self-start h-auto  w-2/3 my-6 bg-blue-900 border-blue-900" >
        ...
        <div class="inline-flex mt-9 place-content-evenly">
          <svg className="text-white mr-6" xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="white" class="bi bi-globe" viewBox="0 0 16 16">
